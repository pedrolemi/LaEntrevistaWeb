...
export default class BasePreloaderScene extends Phaser.Scene {
    ...
    */
    ...
    constructor(key = "PreloaderScene") {
        super({
            key: key,
    ...
    */
    preload(loadAssets = null, dialogNamespaces = [], basicNamespaces = []) {
    ...
    create() {
        ...
        localizationManager.init(this.plugins.get(BasePreloaderScene.REX_TEXT_TRANSLATION_PLUGIN_KEY));
    ...
    */
    loadi18next(dialogNamespaces, basicNamespaces) {
        ...
        */
        ...
        this.plugins.get(BasePreloaderScene.REX_TEXT_TRANSLATION_PLUGIN_KEY).initI18Next(this, {
